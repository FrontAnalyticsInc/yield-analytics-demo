...
|---|---|---|
| `sim` | Builds a deterministic plan for every valve (53 steps, rework loops, scrap, measurements, images) and inserts events once their timestamps have passed. On first start this backfills a year of history; after that, new production appears every 15 minutes. | Python, Pillow |
